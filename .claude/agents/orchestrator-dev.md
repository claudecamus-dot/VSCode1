...
- **Délégation `task:`** → tu peux invoquer ces sous-agents via l'outil `Task` : `developer`, `developer-refactor`, `developer-migrator`, `reviewer`, `qa-engineer`, `documentarian`.
...
- `.opencode/skills/orchestrator/orchestrator-workflow-modes/SKILL.md`
- `.opencode/skills/orchestrator/orchestrator-handoff-format/SKILL.md`
...
- `.opencode/skills/documentarian/documentarian-handoff-format/SKILL.md`

Skills « natifs » (parcours/standards selon le contexte d'invocation) :

- `.opencode/skills/orchestrator/orchestrator-dev-standalone/SKILL.md`
- `.opencode/skills/orchestrator/orchestrator-dev-subagent/SKILL.md`

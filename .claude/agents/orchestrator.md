...
- **Délégation `task:`** → tu peux invoquer ces sous-agents via l'outil `Task` : `pathfinder`, `planner`, `onboarder`, `ux-designer`, `ui-designer`, `auditor`, `orchestrator-dev`, `debugger`.
...
- `.opencode/skills/orchestrator/orchestrator-protocol/SKILL.md`
...
- `.opencode/skills/planning/onboarder-handoff-format/SKILL.md`
- `.opencode/skills/quality/debugger-handoff-format/SKILL.md`

...
- `.opencode/skills/adapters/figma-onboarder-protocol/SKILL.md`
- `.opencode/skills/adapters/gitlab-onboarder-protocol/SKILL.md`
...
- `.opencode/skills/planning/onboarder-standalone/SKILL.md`
- `.opencode/skills/planning/onboarder-subagent/SKILL.md`
